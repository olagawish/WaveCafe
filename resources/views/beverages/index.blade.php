        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="{{ route('beverages.index') }}" class="site_title"><i class="fa fa-graduation-cap"></i></i> <span>Beverages Admin</span></a>
            </div>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      ...
                      <tbody>
                        <tr>
                          <td>{{ $beverage->beverageDate }}</td>
                          <td>{{ $beverage->title }}</td>
                          <td>{{ $beverage->published ? 'Yes' : 'No' }}</td>
                          <td><a href="{{ route('beverages.edit', $beverage->id) }}"><img src="{{ asset('assets/admin/images/edit.png') }}" alt="Edit"></a></td>
                                    <td>
